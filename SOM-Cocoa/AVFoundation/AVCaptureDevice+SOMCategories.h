...
//
//
//  AVCaptureDevice+SOMCategories.h
//  SOM-Cocoa
//
...
@interface AVCaptureDevice (SOMCategories)

//  Returns the video device for the given position.
+ (AVCaptureDevice *)som_findVideoDeviceWithPosition:(AVCaptureDevicePosition)position;

//  Returns the 1st available audio device.
